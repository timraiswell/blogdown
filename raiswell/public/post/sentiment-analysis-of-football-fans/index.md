...
<p>Let’s take a look at the aggregated sentiment for the game in two ways. First we’ll plot a histogram of fan sentiment that will help us to compare the teams side by side. And then we’ll run a t-test to see if the differences in fan sentiment are statistically significant.</p>
